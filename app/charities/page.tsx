    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-slate-900/50 rounded-xl border border-white/10">
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-slate-900/50 rounded-xl border border-white/10 flex gap-4">
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <details className="p-6 bg-slate-900/50 rounded-xl border border-white/10">
